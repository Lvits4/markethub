    ...
    <div>
      ...
      <div className="mt-0.5 flex flex-col gap-2 sm:flex-row sm:items-stretch">
        <button
          ...
          className="flex min-h-[5.5rem] flex-1 flex-col items-center justify-center gap-2 rounded-md border border-dashed border-zinc-300 bg-zinc-50 px-4 py-3 text-sm text-zinc-600 transition hover:border-[var(--color-forest)] hover:bg-zinc-100 disabled:cursor-not-allowed disabled:opacity-50 dark:border-night-600 dark:bg-night-950 dark:text-zinc-400 dark:hover:border-blue-500 dark:hover:bg-night-900"
        >
          {uploading ? (
            <span>Subiendo…</span>
          ) : (
            <>
              ...
              <span>
                {value ? 'Cambiar imagen' : 'Haz clic o suelta una imagen aquí'}
              </span>
        ...
        {value ? (
          <div className="relative flex h-[5.5rem] w-full shrink-0 overflow-hidden rounded-md border border-zinc-200 bg-white dark:border-night-700 dark:bg-night-900 sm:w-[5.5rem]">
            <img
              src={value}
              alt=""
          ...
          <div
            className="flex h-[5.5rem] w-full shrink-0 items-center justify-center rounded-md border border-zinc-200 bg-zinc-50 dark:border-night-700 dark:bg-night-950 sm:w-[5.5rem]"
            aria-hidden
          >
