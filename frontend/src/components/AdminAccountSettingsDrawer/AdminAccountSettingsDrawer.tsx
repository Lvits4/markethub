...
export function AdminAccountSettingsDrawer({
  ...
  return (
    <AdminDrawerWrapper open={open} onClose={onClose} ariaLabel="Ajustes de cuenta">
      <div className="flex shrink-0 items-center justify-between border-b border-slate-200/80 bg-white px-3 py-2.5 dark:border-blue-500/15 dark:bg-admin-drawer-head">
