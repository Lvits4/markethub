...
const TONE_CLASSES: Record<AdminStatusBadgeTone, string> = {
  success:
    'bg-emerald-50 text-emerald-700 ring-emerald-500/25 dark:bg-emerald-400/8 dark:text-emerald-200/90 dark:ring-emerald-400/18',
  danger:
  ...
  info: 'bg-sky-50 text-sky-700 ring-sky-500/25 dark:bg-blue-500/10 dark:text-blue-300 dark:ring-blue-400/25',
...
export function AdminStatusBadge({
  ...
  return (
    <span
      className={`inline-flex items-center rounded-md px-3 py-1 text-xs font-semibold leading-tight ring-1 ring-inset ${TONE_CLASSES[tone]} ${className}`}
    >
      {children}
    </span>
  );
