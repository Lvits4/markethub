  ...
  return (
    <div className="fixed inset-0 z-1 flex items-center justify-center overflow-hidden overscroll-none bg-linear-to-br from-[#e6eaf3] via-auth-bg to-[#dce3ef] px-4 pb-6 pt-8 md:px-5 md:pb-8 md:pt-10 dark:from-night-950 dark:via-night-900 dark:to-night-800">
      ...
      <div className="flex max-h-[calc(100dvh-3.5rem)] w-full max-w-4xl min-h-0 flex-col overflow-x-hidden overflow-y-auto rounded-md bg-white shadow-[0_25px_50px_-12px_rgba(15,23,42,0.12)] ring-1 ring-zinc-900/5 dark:bg-night-900 dark:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.45)] dark:ring-white/6 md:max-h-[calc(100dvh-4.5rem)] lg:flex-row">
        ...
        <div className="relative flex min-h-0 min-w-0 basis-0 flex-col overflow-hidden bg-white px-5 pb-5 pt-6 sm:px-8 sm:pb-7 sm:pt-8 dark:bg-night-900 lg:flex-1 lg:justify-center lg:px-10 lg:pb-8 lg:pt-9">
          <div
