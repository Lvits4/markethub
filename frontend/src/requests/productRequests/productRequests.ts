...
import type { PaginatedProducts, Product, ProductFilters } from '../../types/product/product';
import { fetchDefault, type FetchDefaultAuth } from '../fetchDefault/fetchDefault';
